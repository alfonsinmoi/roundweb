...
export default function Entrenamientos() {
  ...
  return (
    <div className="max-w-5xl space-y-5">
      ...
      <p className="text-xs" style={{ color: 'var(--text-3)' }}>{filtered.length} planes</p>
        ...
        {filtered.map(plan => {
          ...
          return (
            <Card key={plan.id} className="overflow-hidden">
              <button style={{ width: "100%", padding: 28, display: "flex", background: "transparent", border: "none" }} className="flex items-start gap-4 cursor-pointer text-left"
              ...
              {isOpen && (
                <div style={{ padding: "0 28px 28px", borderTop: "1px solid var(--line)" }} style={{ borderColor: 'var(--line)' }}>
