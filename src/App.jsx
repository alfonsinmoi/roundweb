...
const ReservasTab   = lazy(() => import('./pages/PortalCliente/PlaceholderTab').then(m => ({ default: m.ReservasTab })))
const RetosTab      = lazy(() => import('./pages/PortalCliente/PlaceholderTab').then(m => ({ default: m.RetosTab })))
